...
public class VerifyBookingServlet extends HttpServlet {
    ...
    private Logger LOGGER = Logger.getLogger(VerifyBookingServlet.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String subject = "Verify Booking";
        String code = EmailUtil.sendCode();
        String errEmail = null;
        try {
            /* TODO output your page here. You may use following sample code. */
            EmailUtil.sendConfirmEmail(host, port, user, pass, email, subject, code);
            session.setAttribute("BOOKINGCODE", code);
