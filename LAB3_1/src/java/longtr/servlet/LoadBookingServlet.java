 ...
 * @author Admin
 */
@WebServlet(name = "LoadBookingServlet", urlPatterns = {"/LoadBookingServlet"})
public class LoadBookingServlet extends HttpServlet {
    private Logger LOGGER = Logger.getLogger(LoadBookingServlet.class);
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            List<HistoryBookingDTO> listHistoryBooking = hbDao.loadHistoryBooking(aDto.getEmail());
            request.setAttribute("LISTHISTORYBOOKING", listHistoryBooking);
            
//            System.out.println(listHistoryBooking.get(0).getListBookedRoom().get(0).getHotelName());
