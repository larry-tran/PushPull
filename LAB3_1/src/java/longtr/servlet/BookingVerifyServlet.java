 ...
 * @author Admin
 */
@WebServlet(name = "BookingVerifyServlet", urlPatterns = {"/BookingVerifyServlet"})
public class BookingVerifyServlet extends HttpServlet {

    private Logger LOGGER = Logger.getLogger(BookingVerifyServlet.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            EmailUtil.sendEmail(host, port, user, pass, aDto.getEmail(), subject, sentCode);
            session.setAttribute("BOOKINGCODE", sentCode);
